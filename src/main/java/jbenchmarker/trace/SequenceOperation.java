 ...
 * @author urso
 */
public class SequenceOperation implements crdt.Operation {
    ...
    SequenceOperation(OpType type, int replica, int position, int offset, String content, VectorClock VC, SequenceOperationProfile op) {
        this.type = type;
    ...
    static public SequenceOperation insert(int replica, int position, String content, VectorClock VC) {
        return new SequenceOperation(OpType.ins, replica, position, 0, content, VC, null);
    }
    ...
    static public SequenceOperation delete(int replica, int position, int offset, VectorClock VC) {
        return new SequenceOperation(OpType.del, replica, position, offset, null, VC, null);
    }
    
    /*
     * Construction of a random operation 
     */
    static public SequenceOperation random(int replica, VectorClock VC, SequenceOperationProfile op) {
        return new SequenceOperation(OpType.rdm, replica, -1, -1, null, VC, op);
    }
    
    /*
     * Construction of a receive operation 
     */
    static public SequenceOperation receive(int replica, VectorClock VC) {
        return new SequenceOperation(OpType.rcv, replica, -1, -1, null, VC, null);
    }
