 ...
 * @author Mehdi
 */
public class TTFMCMergeAlgorithm extends MergeAlgorithm implements OTReplica<String, TTFOperation> {
    ...
    protected List<Operation> localDelete(SequenceOperation opt) throws IncorrectTraceException {
        TTFMCDocument doc = (TTFMCDocument) this.getDoc();
    ...
    public CRDT<String> create() {
        return new TTFMCMergeAlgorithm(new TTFMCDocument(), 0, otAlgo);
    }
