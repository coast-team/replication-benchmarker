 ...
 * @author urso
 */
public class SequenceOperationProfile implements OperationProfile {
     ...
     */
    public SequenceOperationProfile(double perIns, double perBlock, int avgBlockSize, double sdvBlockSize) {
        this.perIns = perIns;
